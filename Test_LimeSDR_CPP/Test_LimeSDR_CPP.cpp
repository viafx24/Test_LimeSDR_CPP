// Test_LimeSDR_CPP.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
{
    const double frequency = 868e6;  //center frequency to 500 MHz
